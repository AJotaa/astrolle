          ...
          <li className="features-item features-item-one">
            ...
            <div className="features-text">
              ...
              <p className="features-text-paragraph">
                ...
                te permita crecer y tener el soporte oportuno para que el ciclo
                del producto y la venta esten en su flujo normal.
              </p>
            </div>
          </li>
          <li className="features-item features-item-two">
            <div className="features-text">
              ...
              <p className="features-text-paragraph">
                ...
                todo junto ya es bastante complejo, por eso nuestro proyecto va
                un poco más alla, nuestra idea es ayudarte a automatizar tus
                ventas, tus servicios posventa y que tu solo te preocupes en
